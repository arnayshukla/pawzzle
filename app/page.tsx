...
import { Loader2, ImageOff, RefreshCcw, Calendar, Trophy, Share2, Check, Camera, X, EyeOff } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black font-sans flex flex-col pt-12 p-4 sm:p-8 pb-24 sm:pb-32">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-8 w-full max-w-4xl mx-auto">
        <Link 
          href="/daily" 
          className="flex flex-row items-center justify-center gap-1.5 sm:gap-2 py-3 sm:py-3.5 px-2 bg-gradient-to-br from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 text-amber-950 font-bold rounded-2xl shadow-md ring-1 ring-amber-400/50 transition-all hover:scale-105 active:scale-95 text-[14px] sm:text-[15px] whitespace-nowrap"
        >
        ...
        <Link 
          href="/blind" 
          className="flex flex-row items-center justify-center gap-1.5 sm:gap-2 py-3 sm:py-3.5 px-2 bg-zinc-900 border border-zinc-700 hover:bg-zinc-800 text-white font-bold rounded-2xl shadow-md transition-all hover:scale-105 active:scale-95 text-[14px] sm:text-[15px] whitespace-nowrap"
        >
        ...
        <button 
          ...
          className="flex flex-row items-center justify-center gap-1.5 sm:gap-2 py-3 sm:py-3.5 px-2 bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-900 dark:text-zinc-100 font-bold rounded-2xl shadow-sm ring-1 ring-zinc-200 dark:ring-zinc-700 transition-all hover:scale-105 active:scale-95 text-[14px] sm:text-[15px] whitespace-nowrap"
        >
